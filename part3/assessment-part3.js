...
// Find the animal that matches the given id, then call the update function with the animal as the context, and 'Trogdor' as a parameter.
// return the result of your updateAnimal invocation.

function callBinding(arr, fun, num) {
    for (i = 0; i <= arr.length; i++) {
        if (arr[i] === arr[num]) {
            return fun.call(arr[i], 'Trogdor')
        }
    }
};
...
// Find the animal that matches the given id, then call the function with the context of the animal, and the array 
// ['being majestic', 'eating rainbows'] as a parameter.
// return the result of your updateAnimal invocation
